...
CYCLE_STAGES: dict[str, dict] = {
    ...
    "agriculture": {
        ...
        "stage": 4,
        "icon": "🌾",
        "desc": "阶段四：能源传导至农资，逆向左侧埋伏（买在猪价跌时，卖在猪价涨时）",
        "status": "逆向左侧埋伏区",
        "keywords": [
            "农业", "化肥", "农药", "种子", "转基因", "种植",
            "饲料", "农资", "生猪", "养殖", "农机",
...
# ======================================================================
# V5 扩展科技赛道映射 — 修复覆盖率从 3% → ~15%
# ======================================================================
# 变更说明:
# 1. 扩充6大赛道关键词，覆盖计算机/软件/电子/通信/医疗等EM板块名称
# 2. 新增3个赛道: 清洁能源(光伏/风电)、通信/5G、消费电子
# 3. 修复AI医疗赛道0匹配问题（关键词与EM板块名不匹配）
# 4. 修复"租赁"误匹配（移除"算力租赁"关键词，防止反向匹配）

TECH_TRACKS_V5: dict[str, dict] = {
    "chip": {
        "display": "芯片/半导体/算力",
        "icon": "🔧",
        "desc": "打底基建层 — 掘金热潮中的卖铲人",
...
# V5 卖铲人赛道（基础设施层，额外加分）
SHOVEL_SELLER_TRACKS_V5 = {"chip", "new_energy_vehicle", "new_energy", "telecom"}
